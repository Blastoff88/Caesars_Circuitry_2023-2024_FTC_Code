...
@Autonomous(name = "redLeftInner")
@Disabled
public class opencvRedAuto4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence TrajSeqR = drivetrain.trajectorySequenceBuilder(new Pose2d(-35,-64,Math.toRadians(-90)))
                ...
                .strafeRight(36)
                .forward(58)
                .lineToLinearHeading(new Pose2d(80,-32, Math.toRadians(180)))
        ...
        TrajectorySequence TrajSeqL = drivetrain.trajectorySequenceBuilder(new Pose2d(-35,-64,Math.toRadians(-90)))
                ...
                .strafeLeft(36)
                .back(58)
                .lineToLinearHeading(new Pose2d(76,-8, Math.toRadians(180)))
