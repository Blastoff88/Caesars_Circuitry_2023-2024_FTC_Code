...
@Autonomous(name = "redRightInner")
@Disabled
public class opencvRedAuto3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence TrajSeqM = drivetrain.trajectorySequenceBuilder(new Pose2d(10,-64,Math.toRadians(-90)))
                ...
                .splineToSplineHeading(new Pose2d(64, -22, Math.toRadians(180)), Math.toRadians(0))
                .addTemporalMarker(6,()->{
                    Yellow.setPosition(.45);
                })
