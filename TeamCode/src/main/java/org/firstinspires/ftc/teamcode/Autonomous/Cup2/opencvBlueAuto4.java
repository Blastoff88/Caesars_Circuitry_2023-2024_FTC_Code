...
@Autonomous(name = "blueRightInner")
@Disabled
public class opencvBlueAuto4 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        TrajectorySequence TrajSeqL = drivetrain.trajectorySequenceBuilder(new Pose2d(-35,64,Math.toRadians(90)))
                .lineToLinearHeading(new Pose2d(-35,20,Math.toRadians(0)))
                .lineTo(new Vector2d(-21,20))
                ...
                .strafeLeft(36)
                .forward(58)
                .lineToLinearHeading(new Pose2d(81,36, Math.toRadians(180)))
...
//                .strafeRight(20)
                .build();
        TrajectorySequence TrajSeqM = drivetrain.trajectorySequenceBuilder(new Pose2d(-35,64,Math.toRadians(90)))
                ...
                .strafeLeft(65)
                .lineToLinearHeading(new Pose2d(90,18, Math.toRadians(180)))
...
//                .strafeRight(27)
                .build();
        TrajectorySequence TrajSeqR = drivetrain.trajectorySequenceBuilder(new Pose2d(-35,64,Math.toRadians(90)))
                ...
                .strafeRight(36)
                .back(58)
                .lineToLinearHeading(new Pose2d(76,18, Math.toRadians(180)))
                .addTemporalMarker(10.2,()->{
                    Yellow.setPosition(.45);
                })
                .addTemporalMarker(11.2,()->{
                    Yellow.setPosition(0);
                })
                .forward(3)
                .strafeLeft(24)
