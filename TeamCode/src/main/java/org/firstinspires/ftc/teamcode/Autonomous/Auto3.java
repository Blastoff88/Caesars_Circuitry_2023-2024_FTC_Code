...
public class Auto3 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            imuDrive(0.5, 1000, 90);

            // Example: Turn 90 degrees while maintaining the heading
            imuTurn(0.3, 90);

            // Example: Strafe left for 500 units while maintaining the heading
            imuStrafe(0.5, 500, 90);
        }
    }
    ...
    public void imuTurn(double power, double targetHeading) {
